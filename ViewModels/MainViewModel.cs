...
namespace MauiApp1.ViewModels
{
    public class MainViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            var airSensor = new AirQualitySensor(55.9448, -3.1878); // Edinburgh Nicolson Street
            var waterSensor = new WaterQualitySensor(55.8611, -3.2539); // Glencorse B
            var weatherSensor = new WeatherQualitySensor(55.0088, -3.5856); // Open-Meteo (8 m elevation)

          
            // 10 readings for AirQualitySensor (Edinburgh)
            ...
            // 10 readings for WaterQualitySensor (Glencorse B)
            ...
            // 10 readings for WeatherQualitySensor (Paris)
